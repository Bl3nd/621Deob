...
final class jaa
{
    ...
    private int[] j;
    private int[] k;
    private static int[] l = { 256, 128, 86, 64 };
    
    final void a(float[] fs, int i) {
	int i_0_ = j.length;
	int i_1_ = l[d - 1];
	a[0] = a[1] = true;
	for (int i_2_ = 2; i_2_ < i_0_; i_2_++) {
	    int i_3_ = a(e, i_2_);
	    int i_4_ = b(e, i_2_);
	    int i_5_ = a(e[i_3_], jaa.f[i_3_], e[i_4_], jaa.f[i_4_], e[i_2_]);
	    int i_6_ = jaa.f[i_2_];
	    int i_7_ = i_1_ - i_5_;
	    int i_8_ = i_5_;
		...
		a[i_2_] = true;
		if (i_6_ >= i_9_)
		    jaa.f[i_2_] = (i_7_ > i_8_ ? i_6_ - i_8_ + i_5_
				   : i_5_ - i_6_ + i_7_ - 1);
		else
		    jaa.f[i_2_] = ((i_6_ & 0x1) != 0 ? i_5_ - (i_6_ + 1) / 2
				   : i_5_ + i_6_ / 2);
	    } else {
		a[i_2_] = false;
		jaa.f[i_2_] = i_5_;
	...
	for (int i_12_ = 1; i_12_ < i_0_; i_12_++) {
	    if (a[i_12_]) {
		int i_13_ = e[i_12_];
		int i_14_ = jaa.f[i_12_] * d;
		a(i_10_, i_11_, i_13_, i_14_, fs, i);
		if (i_13_ >= i)
		    return;
		i_10_ = i_13_;
		i_11_ = i_14_;
    ...
    private final void a(int i, int i_16_, int i_17_, int i_18_, float[] fs,
			 int i_19_) {
	...
	for (int i_27_ = i + 1; i_27_ < i_17_; i_27_++) {
		...
		i_24_ += i_23_;
	    fs[i_27_] *= jaa.i[i_24_];
	}
    }
    
    private static final int a(int[] is, int i) {
	int i_28_ = is[i];
	int i_29_ = -1;
    ...
    private final void a(int i, int i_33_) {
	if (i < i_33_) {
	    int i_34_ = i;
	    int i_35_ = e[i_34_];
	    int i_36_ = f[i_34_];
	    boolean bool = a[i_34_];
    ...
    private static final int b(int[] is, int i) {
	int i_39_ = is[i];
	int i_40_ = -1;
    ...
    private final int a(int i, int i_44_, int i_45_, int i_46_, int i_47_) {
	int i_48_ = i_46_ - i_44_;
	int i_49_ = i_45_ - i;
	int i_50_ = i_48_ < 0 ? -i_48_ : i_48_;
	int i_51_ = i_50_ * (i_47_ - i);
	...
	for (int i_53_ = 0; i_53_ < i; i_53_++)
	    e[i_53_] = j[i_53_];
	int i_54_ = l[d - 1];
	int i_55_ = it.a(-24420, i_54_ - 1);
	f[0] = go.c(i_55_);
	f[1] = go.c(i_55_);
	int i_56_ = 2;
	for (int i_57_ = 0; i_57_ < k.length; i_57_++) {
	    int i_58_ = k[i_57_];
	    int i_59_ = g[i_58_];
	    int i_60_ = b[i_58_];
	    int i_61_ = (1 << i_60_) - 1;
	    int i_62_ = 0;
	    if (i_60_ > 0)
		i_62_ = go.w[h[i_58_]].c();
	    for (int i_63_ = 0; i_63_ < i_59_; i_63_++) {
		int i_64_ = c[i_58_][i_62_ & i_61_];
		i_62_ >>>= i_60_;
		f[i_56_++] = i_64_ >= 0 ? go.w[i_64_].c() : 0;
	    }
	}
	return true;
    }
	...
	for (int i_75_ = 0; i_75_ < i_65_; i_75_++) {
	    int i_76_ = k[i_75_];
	    for (int i_77_ = 0; i_77_ < g[i_76_]; i_77_++)
		j[i_73_++] = go.c(i_72_);
	}
	if (e == null || e.length < i_73_) {
	    e = new int[i_73_];
	    f = new int[i_73_];
	    a = new boolean[i_73_];
	}
