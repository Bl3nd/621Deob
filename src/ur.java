...
abstract class ur {
    ...
    static final Commands a(String string, int i, int i_2_, qj var_qj) {
        if (i != -65536)
            return null;
        d++;
        ...
        OpenGL.glBindProgramARB(i_2_, 0);
        return new Commands(var_qj, i_2_, i_3_);
    }

    public static int getProfileCPU(int i) {
        b++;
        ...
        long currentTime = us.getCurrentTime(94);
        if (i >= -106) {
            return 39;
        }
        ...
        int currentTime_ = (int) (us.getCurrentTime(95) - currentTime);
    ...
    /**
     * Sets the tk version. Called by the commands (tk#).
     * @param i
     * @param bool
     */
    public static void setTKVersion(int i, boolean bool) {
        if (!bool) {
            c = null;
        }
        setTKVersion++;
        Class_pf.a(i, (byte) -126, GameText.loadingPleaseWait.getString(cba.languageID));
    }
