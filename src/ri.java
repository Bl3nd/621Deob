...
final class ri extends pp {
    ...
    static final void a(boolean bool, boolean bool_0_, int i, int i_1_,
        ...
        if (ol.p == null)
            ...
            if (up.thisPlayer != null
                    && ((Animable) up.thisPlayer).locX - 256 * (up.thisPlayer.getNPCDefinition(-1) - 1) >> 9 == bca.c
                    && ((Animable) up.thisPlayer).locY - (up.thisPlayer.getNPCDefinition(-1) - 1) * 256 >> 9 == uaa.h) {
                bca.c = -1;
                uaa.h = -1;
                ho.a(!bool);
            }
    ...
    public static void showFPS(int fps, int j) {
        nh.j = 1000000000L / (long) fps;
        showFPS++;
        if (j > -29) {
            u = -85;
        }
