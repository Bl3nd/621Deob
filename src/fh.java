...
final class fh
{
	...
	try {
	    ...
	    String string = ("T2 - " + (sw.currentGameInPacket == null ? -1 : sw.currentGameInPacket.getPacketID(25569))
			     + "," + (ClientScript.gameInPacket == null ? -1 : ClientScript.gameInPacket.getPacketID(25569))
			     + "," + (jt.c != null ? jt.c.getPacketID(25569) : -1)
