...
final class rh extends bm
{
	...
	if (string != null) {
		...
		cba.a(4, false, GameText.s.getString((byte) -109, cba.languageID));
		String string_6_ = GameText.t.getString((byte) -113, cba.languageID);
		if (string_6_ != null)
		...
		if (string_7_ != null) {
			...
			if (string_9_ != null && string_9_.equals(string_7_)) {
			    cba.a(4, false,
				  string + GameText.U.getString((byte) 114, cba.languageID));
			    return;
			}
			if (nj.l[i_8_] != null) {
				...
				cba.a(4, false,
				      string + GameText.U.getString((byte) -51, cba.languageID));
				return;
			    }
			}
		    }
			...
			if (string_12_ != null
			    ...
			    cba.a(4, false, (GameText.Z.getString((byte) -52, cba.languageID) + string
					     + GameText.ab.getString((byte) 90, cba.languageID)));
			    return;
			}
			if (mba.a[i_11_] != null) {
				...
				cba.a(4, false,
				      (GameText.Z.getString((byte) -35, cba.languageID) + string
				       + GameText.ab.getString((byte) 127, cba.languageID)));
				return;
			    }
			}
		    }
		    if (kk.a(((Player) up.thisPlayer).displayName, true).equals(string_7_))
			cba.a(4, false, GameText.X.getString((byte) -127, cba.languageID));
		    else {
			ki.c++;
