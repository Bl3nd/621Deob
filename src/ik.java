...
final class ik
{
	...
	if (lda.r == nw.a)
	    kr.a(cs.i, 126, Node.f(-118), caa.G);
	if (lda.s == nw.a) {
	    int i_11_ = hba.a((byte) -120);
	    int i_12_ = GameText.a(110);
	    if (i_11_ < i_12_)
	...
	if (nw.a == lda.v) {
	    ...
	    Login.i = hq.a(false, 1, 1000000, 27);
	...
	if (nw.a == lda.A) {
	    if ((ao.h ^ 0xffffffff) != 0 && !av.l.a(0, (byte) 109, ao.h))
		return 99;
	    ...
	    Class_ae.n = new PlayerUpdateLocation(me.q, cba.languageID, fu.b, av.l);
	    vd.L = new sm(me.q, cba.languageID, fu.b);
	    lr.k = new br(me.q, cba.languageID, fu.b);
	    ul.k = new ek(me.q, cba.languageID, true, id.j, av.l);
	    hq.a = new aw(me.q, cba.languageID, fu.b, sm.a);
	    gda.d = new sj(me.q, cba.languageID, fu.b, sm.a);
	    jm.p = new Class_lb(me.q, cba.languageID, true, nk.g, av.l);
	    laa.itemDefLoader = new ItemDefLoader(me.q, cba.languageID, true, jba.b, sh.i, av.l);
	    GameInPacket.d = new ih(me.q, cba.languageID, fu.b);
	    Class_ef.J = new hl(me.q, cba.languageID, kq.W, GameOutPacket.pl, ada.M);
	    hi.u = new hu(me.q, cba.languageID, fu.b);
	    ps.a = new nk(me.q, cba.languageID, fu.b);
	    Class_ic.H = new bea(me.q, cba.languageID, vq.l, av.l);
	    ...
	    ce.a(cs.i, ui.c, sm.a, av.l, (byte) -108);
	    ...
	    cp.e = new dj();
	    bca.a((byte) 56);
	    ss.a(Login.i, (byte) 57);
	    wl.a(av.l, on.c, -27984);
	...
	if (nw.a == lda.D) {
	    ...
	    int i_18_ = dp.b(-124) + GameText.a(94);
	    if (i_17_ < i_18_)
	...
	if (lda.F == nw.a) {
	    client.ob = new String[((Class_hc) hu.l).d];
	...
	if (lda.G == nw.a) {
		...
		return 0;
	    for (int i_21_ = 0; aa.o[nh.k].length > i_21_; i_21_++) {
		Interface var_kp = aa.o[nh.k][i_21_];
		if (((Interface) var_kp).type == 5 && ((Interface) var_kp).textureID != -1)
		    var_kp.a(lg.r, -91);
	    }
	}
	if (lda.H == nw.a) {
	    for (int i_22_ = 0; aa.o[nh.k].length > i_22_; i_22_++) {
		Interface var_kp = aa.o[nh.k][i_22_];
	...
	if (nw.a == lda.J) {
		...
		ur.a(((jb) cs.g).M, true);
	    kea.a(false, (byte) 126, -1, -1, ((jb) cs.g).w);
	    ISAAC.a(8, lg.r);
	    bn.a(lg.r, -27346);
	    um.a(sm.a, lg.r, 0);
	    iea.a(true, sp.s);
    ...
    static final boolean a(int i, boolean bool) {
	d++;
	boolean bool_23_ = lg.r.z();
