...
public final class TransparentSprite extends qp {

    int[] H;

    public TransparentSprite(nga nga, int[] buf, int i, int j) {
        super(nga, i, j);
        this.H = buf;
    }

    public final void da(int i, int j, int k, int i1, int j1, int k1) {
        int[] buf = this.b.H;
        for (int i2 = 0; i2 < i1; i2++) {
            int j2 = (j + i2) * this.k + i;
            int k2 = (k1 + i2) * ((qp) this).b.C + j1;
            for (int i3 = 0; i3 < k; i3++) {
                this.H[j2 + i3] = buf[k2 + i3];
            }
        }
    }

    public final void a(int i, int j, ua ua, int k, int i1) {
        if (this.b.E()) {
        ...
        if (i2 > 0 && j2 > 0) {
            ...
            int length = (i1 + buf1.length < j + j2 ? i1 + buf1.length : j + j2);
            for (int i4 = k3; i4 < length; i4++) {
                int j4 = buf1[i4 - i1] + k;
                int k4 = buf2[i4 - i1];
                int i5 = i2;
                if (i > j4) {
                ...
                for (int count = -k4; count < 0; count++) {
                    int k5 = this.H[j1++];
                    if (k5 != 0) {
                        buf3[j3++] = k5;
                    } else {
    ...
    public final void a(int[] buf, int[] buf1, int i, int j) {
        int[] buf2 = this.b.H;
        if (qp.h == 0) {
            if (qp.n == 0) {
                int k = qp.F;
                while (k < 0) {
                    ...
                    if (i1 >= 0) {
                        ...
                        int i2 = qp.z;
                        int j2 = qp.y;
                        if (k1 >= 0 && i2 >= 0 && k1 - (this.k << 12) < 0 && i2 - (this.o << 12) < 0) {
                            int k2 = buf[i1] - i;
                            int i3 = -buf1[i1];
                            int j3 = k2 - (j1 - qp.v);
                            if (j3 > 0) {
                            ...
                            for (/**/; j2 < 0; j2++) {
                                int k3 = (this.H[((i2 >> 12) * this.k + (k1 >> 12))]);
                                if (k3 != 0) {
                                    buf2[j1++] = k3;
                                } else {
                                    j1++;
                ...
                while (k < 0) {
                    ...
                    if (i1 >= 0) {
                        ...
                        int i2 = qp.z + qp.c;
                        int j2 = qp.y;
                        if (k1 >= 0 && k1 - (this.k << 12) < 0) {
                            int k2;
                            if ((k2 = i2 - (this.o << 12)) >= 0) {
                                k2 = (qp.n - k2) / qp.n;
                                j2 += k2;
                                i2 += qp.n * k2;
                                j1 += k2;
                            }
                            if ((k2 = (i2 - qp.n) / qp.n) > j2) {
                                j2 = k2;
                            }
                            int i3 = buf[i1] - i;
                            int j3 = -buf1[i1];
                            ...
                            for (/**/; j2 < 0; j2++) {
                                int i4 = (this.H[((i2 >> 12) * this.k + (k1 >> 12))]);
                                if (i4 != 0) {
                                    buf2[j1++] = i4;
                                } else {
                                    j1++;
                ...
                while (k < 0) {
                    ...
                    if (i1 >= 0) {
                        ...
                        if (k1 >= 0 && k1 - (this.k << 12) < 0) {
                            if (i2 < 0) {
                                int k2 = (qp.n - 1 - i2) / qp.n;
                                j2 += k2;
                                i2 += qp.n * k2;
                                j1 += k2;
                            }
                            int k2;
                            if ((k2 = (i2 + 1 - (this.o << 12) - qp.n) / qp.n) > j2) {
                                j2 = k2;
                            }
                            int i3 = buf[i1] - i;
                            int j3 = -buf1[i1];
            ...
            if (qp.n == 0) {
                ...
                while (k < 0) {
                    ...
                    if (i1 >= 0) {
                        ...
                        int i2 = qp.z;
                        int j2 = qp.y;
                        if (i2 >= 0 && i2 - (this.o << 12) < 0) {
                            int k2;
                            if ((k2 = k1 - (this.k << 12)) >= 0) {
                                k2 = (qp.h - k2) / qp.h;
                                j2 += k2;
                                k1 += qp.h * k2;
                                j1 += k2;
                            }
                            if ((k2 = (k1 - qp.h) / qp.h) > j2) {
                                j2 = k2;
                            }
                            int i3 = buf[i1] - i;
                            int j3 = -buf1[i1];
                ...
                while (i_94_ < 0) {
                    ...
                    if (i_95_ >= 0) {
                        ...
                        if ((i_100_ = (i_98_ + 1 - (this.o << 12)
                                - qp.n) / qp.n)
                                > i_99_)
                            i_99_ = i_100_;
                        int i_101_ = buf[i_95_] - i;
                        int i_102_ = -buf1[i_95_];
            ...
            while (k < 0) {
                ...
                if (i1 >= 0) {
                    ...
                    if (i2 >= 0 && i2 - (this.o << 12) < 0) {
                        if (k1 < 0) {
                            int k2 = (qp.h - 1 - k1) / qp.h;
                            j2 += k2;
                            k1 += qp.h * k2;
                            j1 += k2;
                        }
                        int k2;
                        if ((k2 = (k1 + 1 - (this.k << 12) - qp.h) / qp.h) > j2) {
                            j2 = k2;
                        }
                        int i3 = buf[i1] - i;
                        int j3 = -buf1[i1];
    ...
    final void V(int i, int i_141_, int i_142_, int i_143_, int i_144_) {
        ...
        int i_151_ = 0;
        if (i_141_ < this.b.u) {
            int i_152_ = this.b.u - i_141_;
            i_148_ -= i_152_;
            i_141_ = this.b.u;
            i_147_ += i_152_ * i_149_;
            i_146_ += i_152_ * i_145_;
        }
        if (i_141_ + i_148_ > ((qp) this).b.cb)
            i_148_ -= i_141_ + i_148_ - ((qp) this).b.cb;
        if (i < this.b.Y) {
            int i_153_ = this.b.Y - i;
            i_149_ -= i_153_;
            i = this.b.Y;
            i_147_ += i_153_;
            i_146_ += i_153_;
        ...
        if (i + i_149_ > this.b.B) {
            int i_154_ = i + i_149_ - this.b.B;
            i_149_ -= i_154_;
            i_151_ += i_154_;
            i_150_ += i_154_;
        }
            ...
            if (i_144_ == 1) {
                if (i_142_ == 1) {
                    for (int i_179_ = -i_148_; i_179_ < 0; i_179_++) {
                        ...
                        while (i_146_ < i_180_) {
                            int i_181_ = this.H[i_147_++];
                            if (i_181_ != 0)
                                is[i_146_++] = i_181_;
                            else
                                i_146_++;
                            i_181_ = this.H[i_147_++];
                            if (i_181_ != 0)
                                is[i_146_++] = i_181_;
                            else
                                i_146_++;
    ...
    final void YA(int i, int i_253_, int i_254_, int i_255_, int i_256_,
        ...
        if (i_254_ > 0 && i_255_ > 0) {
            ...
            int i_261_ = 0;
            int i_262_ = this.b.C;
            int i_263_ = this.E + this.k + this.q;
            int i_264_ = this.f + this.o + this.C;
            int i_265_ = (i_263_ << 16) / i_254_;
            int i_266_ = (i_264_ << 16) / i_255_;
            if (this.E > 0) {
                int i_267_ = ((this.E << 16) + i_265_ - 1) / i_265_;
                i += i_267_;
                i_260_ += i_267_ * i_265_ - (this.E << 16);
            }
            if (this.f > 0) {
                int i_268_ = ((this.f << 16) + i_266_ - 1) / i_266_;
                i_253_ += i_268_;
                i_261_ += i_268_ * i_266_ - (this.f << 16);
            }
            if (this.k < i_263_)
                i_254_
                        = ((this.k << 16) - i_260_ + i_265_ - 1) / i_265_;
            if (this.o < i_264_)
                i_255_
                        = ((this.o << 16) - i_261_ + i_266_ - 1) / i_266_;
            int i_269_ = i + i_253_ * i_262_;
            int i_270_ = i_262_ - i_254_;
            if (i_253_ + i_255_ > this.b.cb)
                i_255_ -= i_253_ + i_255_ - this.b.cb;
            if (i_253_ < ((qp) this).b.u) {
                int i_271_ = this.b.u - i_253_;
                i_255_ -= i_271_;
                i_269_ += i_271_ * i_262_;
                i_261_ += i_266_ * i_271_;
            }
            if (i + i_254_ > ((qp) this).b.B) {
                int i_272_ = i + i_254_ - this.b.B;
                i_254_ -= i_272_;
                i_270_ += i_272_;
            }
            if (i < this.b.Y) {
                int i_273_ = this.b.Y - i;
                i_254_ -= i_273_;
                i_269_ += i_273_;
            ...
            if (i_258_ == 0) {
                if (i_256_ == 1) {
                    ...
                    for (int i_275_ = -i_255_; i_275_ < 0; i_275_++) {
                        int i_276_ = (i_261_ >> 16) * this.k;
                        for (int i_277_ = -i_254_; i_277_ < 0; i_277_++) {
                            is[i_269_++]
                                    = this.H[(i_260_ >> 16) + i_276_];
                            i_260_ += i_265_;
                        }
                        i_261_ += i_266_;
                        i_260_ = i_274_;
                ...
                if (i_256_ == 0) {
                    ...
                    for (int i_282_ = -i_255_; i_282_ < 0; i_282_++) {
                        int i_283_ = (i_261_ >> 16) * this.k;
                        for (int i_284_ = -i_254_; i_284_ < 0; i_284_++) {
                            int i_285_
                                    = this.H[(i_260_ >> 16) + i_283_];
                            int i_286_
                ...
                if (i_256_ == 3) {
                    ...
                    for (int i_290_ = -i_255_; i_290_ < 0; i_290_++) {
                        int i_291_ = (i_261_ >> 16) * this.k;
                        for (int i_292_ = -i_254_; i_292_ < 0; i_292_++) {
                            int i_293_
                                    = this.H[(i_260_ >> 16) + i_291_];
                ...
                if (i_256_ == 2) {
                    ...
                    for (int i_302_ = -i_255_; i_302_ < 0; i_302_++) {
                        int i_303_ = (i_261_ >> 16) * this.k;
                        for (int i_304_ = -i_254_; i_304_ < 0; i_304_++) {
                            int i_305_
                                    = this.H[(i_260_ >> 16) + i_303_];
            ...
            if (i_258_ == 1) {
                if (i_256_ == 1) {
                    ...
                    for (int i_307_ = -i_255_; i_307_ < 0; i_307_++) {
                        int i_308_ = (i_261_ >> 16) * this.k;
                        for (int i_309_ = -i_254_; i_309_ < 0; i_309_++) {
                            int i_310_
                                    = this.H[(i_260_ >> 16) + i_308_];
                            if (i_310_ != 0)
                                is[i_269_++] = i_310_;
                            else
                                i_269_++;
                ...
                if (i_256_ == 0) {
                    ...
                    if ((i_257_ & 0xffffff) == 16777215) {
                        ...
                        for (int i_314_ = -i_255_; i_314_ < 0; i_314_++) {
                            int i_315_ = (i_261_ >> 16) * this.k;
                            for (int i_316_ = -i_254_; i_316_ < 0; i_316_++) {
                                int i_317_
                                        = this.H[(i_260_ >> 16) + i_315_];
                                if (i_317_ != 0) {
                        ...
                        for (int i_324_ = -i_255_; i_324_ < 0; i_324_++) {
                            int i_325_ = (i_261_ >> 16) * this.k;
                            for (int i_326_ = -i_254_; i_326_ < 0; i_326_++) {
                                int i_327_
                                        = this.H[(i_260_ >> 16) + i_325_];
                                if (i_327_ != 0) {
                                    if (i_322_ != 255) {
                                        int i_328_
                ...
                if (i_256_ == 3) {
                    ...
                    for (int i_338_ = -i_255_; i_338_ < 0; i_338_++) {
                        int i_339_ = (i_261_ >> 16) * this.k;
                        for (int i_340_ = -i_254_; i_340_ < 0; i_340_++) {
                            int i_341_
                                    = this.H[(i_260_ >> 16) + i_339_];
                ...
                if (i_256_ == 2) {
                    ...
                    for (int i_350_ = -i_255_; i_350_ < 0; i_350_++) {
                        int i_351_ = (i_261_ >> 16) * this.k;
                        for (int i_352_ = -i_254_; i_352_ < 0; i_352_++) {
                            int i_353_
                                    = this.H[(i_260_ >> 16) + i_351_];
                            if (i_353_ != 0) {
                                i_347_
            ...
            if (i_258_ == 2) {
                if (i_256_ == 1) {
                    ...
                    for (int i_355_ = -i_255_; i_355_ < 0; i_355_++) {
                        int i_356_ = (i_261_ >> 16) * this.k;
                        for (int i_357_ = -i_254_; i_357_ < 0; i_357_++) {
                            int i_358_
                                    = this.H[(i_260_ >> 16) + i_356_];
                            if (i_358_ != 0) {
                ...
                if (i_256_ == 0) {
                    ...
                    for (int i_366_ = -i_255_; i_366_ < 0; i_366_++) {
                        int i_367_ = (i_261_ >> 16) * this.k;
                        for (int i_368_ = -i_254_; i_368_ < 0; i_368_++) {
                            int i_369_
                                    = this.H[(i_260_ >> 16) + i_367_];
                            if (i_369_ != 0) {
                                int i_370_
                ...
                if (i_256_ == 3) {
                    ...
                    for (int i_377_ = -i_255_; i_377_ < 0; i_377_++) {
                        int i_378_ = (i_261_ >> 16) * this.k;
                        for (int i_379_ = -i_254_; i_379_ < 0; i_379_++) {
                            int i_380_
                                    = this.H[(i_260_ >> 16) + i_378_];
                ...
                if (i_256_ == 2) {
                    ...
                    for (int i_389_ = -i_255_; i_389_ < 0; i_389_++) {
                        int i_390_ = (i_261_ >> 16) * this.k;
                        for (int i_391_ = -i_254_; i_391_ < 0; i_391_++) {
                            int i_392_
                                    = this.H[(i_260_ >> 16) + i_390_];
                            if (i_392_ != 0) {
                                i_386_
        ...
        if (qp.h == 0) {
            if (qp.n == 0) {
                ...
                while (i_407_ < 0) {
                    ...
                    if (i_409_ >= 0 && i_410_ >= 0
                        ...
                        for (/**/; i_411_ < 0; i_411_++) {
                            ...
                            if (i_416_ == 0) {
                                if (i_415_ == 1)
                                    is_414_[i_413_] = this.H[i_412_];
                                else if (i_415_ == 0) {
                                    int i_417_ = this.H[i_412_++];
                                ...
                                if (i_415_ == 1) {
                                    int i_429_ = this.H[i_412_];
                                    if (i_429_ != 0)
                                        is_414_[i_413_] = i_429_;
                                } else if (i_415_ == 0) {
                                    int i_430_ = this.H[i_412_];
                                    if (i_430_ != 0) {
                ...
                while (i_471_ < 0) {
                    ...
                    int i_475_ = qp.y;
                    if (i_473_ >= 0 && i_473_ - (this.k << 12) < 0) {
                        int i_476_;
                        if ((i_476_ = i_474_ - (this.o << 12)) >= 0) {
                        ...
                        for (/**/; i_475_ < 0; i_475_++) {
                            ...
                            if (i_481_ == 0) {
                                if (i_480_ == 1)
                                    is_479_[i_478_] = this.H[i_477_];
                                else if (i_480_ == 0) {
                                    int i_482_ = this.H[i_477_++];
                                ...
                                if (i_480_ == 1) {
                                    int i_494_ = this.H[i_477_];
                                    if (i_494_ != 0)
                                        is_479_[i_478_] = i_494_;
                                } else if (i_480_ == 0) {
                                    int i_495_ = this.H[i_477_];
                                    if (i_495_ != 0) {
                                        if ((qp.w & 0xffffff) == 16777215) {
                                            int i_496_ = qp.w >>> 24;
                ...
                while (i_536_ < 0) {
                    ...
                    int i_540_ = qp.y;
                    if (i_538_ >= 0 && i_538_ - (this.k << 12) < 0) {
                        if (i_539_ < 0) {
                        ...
                        int i_542_;
                        if ((i_542_ = (i_539_ + 1 - (this.o << 12)
                                - qp.n) / qp.n)
                                > i_540_)
                            i_540_ = i_542_;
                        for (/**/; i_540_ < 0; i_540_++) {
                            int i_543_ = ((i_539_ >> 12) * this.k
                                    + (i_538_ >> 12));
                            int i_544_ = i_537_++;
                            int[] is_545_ = is;
                            int i_546_ = i;
                            ...
                            if (i_547_ == 0) {
                                if (i_546_ == 1)
                                    is_545_[i_544_] = this.H[i_543_];
                                else if (i_546_ == 0) {
                                    int i_548_ = this.H[i_543_++];
                                ...
                                if (i_546_ == 1) {
                                    int i_560_ = this.H[i_543_];
                                    if (i_560_ != 0)
                                        is_545_[i_544_] = i_560_;
                                } else if (i_546_ == 0) {
                                    int i_561_ = this.H[i_543_];
                                    if (i_561_ != 0) {
                                        if ((qp.w & 0xffffff) == 16777215) {
                                            int i_562_ = qp.w >>> 24;
            ...
            if (qp.n == 0) {
                ...
                while (i_602_ < 0) {
                    ...
                    int i_605_ = qp.z;
                    int i_606_ = qp.y;
                    if (i_605_ >= 0 && i_605_ - (this.o << 12) < 0) {
                        int i_607_;
                        if ((i_607_ = i_604_ - (this.k << 12)) >= 0) {
                        ...
                        for (/**/; i_606_ < 0; i_606_++) {
                            ...
                            if (i_612_ == 0) {
                                if (i_611_ == 1)
                                    is_610_[i_609_] = this.H[i_608_];
                                else if (i_611_ == 0) {
                                    int i_613_ = this.H[i_608_++];
                                ...
                                if (i_611_ == 1) {
                                    int i_625_ = this.H[i_608_];
                                    if (i_625_ != 0)
                                        is_610_[i_609_] = i_625_;
                                } else if (i_611_ == 0) {
                                    int i_626_ = this.H[i_608_];
                                    if (i_626_ != 0) {
                                        if ((qp.w & 0xffffff) == 16777215) {
                                            int i_627_ = qp.w >>> 24;
                ...
                while (i_667_ < 0) {
                    ...
                    for (/**/; i_671_ < 0; i_671_++) {
                        ...
                        if (i_677_ == 0) {
                            if (i_676_ == 1)
                                is_675_[i_674_] = this.H[i_673_];
                            else if (i_676_ == 0) {
                                int i_678_ = this.H[i_673_++];
                                int i_679_
                            ...
                            if (i_676_ == 1) {
                                int i_690_ = this.H[i_673_];
                                if (i_690_ != 0)
                                    is_675_[i_674_] = i_690_;
                            } else if (i_676_ == 0) {
                                int i_691_ = this.H[i_673_];
                                if (i_691_ != 0) {
                                    if ((qp.w & 0xffffff) == 16777215) {
                                        int i_692_ = qp.w >>> 24;
                ...
                while (i_732_ < 0) {
                    ...
                    if ((i_737_
                            = (i_735_ + 1 - (this.o << 12) - qp.n) / qp.n)
                            > i_736_)
                        i_736_ = i_737_;
                    for (/**/; i_736_ < 0; i_736_++) {
                        int i_738_
                                = (i_735_ >> 12) * this.k + (i_734_ >> 12);
                        int i_739_ = i_733_++;
                        int[] is_740_ = is;
                        int i_741_ = i;
                        int i_742_ = i_406_;
                        if (i_742_ == 0) {
                            if (i_741_ == 1)
                                is_740_[i_739_] = this.H[i_738_];
                            else if (i_741_ == 0) {
                                int i_743_ = this.H[i_738_++];
                                int i_744_
                            ...
                            if (i_741_ == 1) {
                                int i_755_ = this.H[i_738_];
                                if (i_755_ != 0)
                                    is_740_[i_739_] = i_755_;
                            } else if (i_741_ == 0) {
                                int i_756_ = this.H[i_738_];
                                if (i_756_ != 0) {
                                    if ((qp.w & 0xffffff) == 16777215) {
                                        int i_757_ = qp.w >>> 24;
            ...
            while (i_797_ < 0) {
                ...
                int i_800_ = qp.z;
                int i_801_ = qp.y;
                if (i_800_ >= 0 && i_800_ - (this.o << 12) < 0) {
                    if (i_799_ < 0) {
                    ...
                    int i_803_;
                    if ((i_803_
                            = (i_799_ + 1 - (this.k << 12) - qp.h) / qp.h)
                            > i_801_)
                        i_801_ = i_803_;
                    for (/**/; i_801_ < 0; i_801_++) {
                        int i_804_
                                = (i_800_ >> 12) * this.k + (i_799_ >> 12);
                        int i_805_ = i_798_++;
                        int[] is_806_ = is;
                        int i_807_ = i;
                        int i_808_ = i_406_;
                        if (i_808_ == 0) {
                            if (i_807_ == 1)
                                is_806_[i_805_] = this.H[i_804_];
                            else if (i_807_ == 0) {
                                int i_809_ = this.H[i_804_++];
                                int i_810_
                            ...
                            if (i_807_ == 1) {
                                int i_821_ = this.H[i_804_];
                                if (i_821_ != 0)
                                    is_806_[i_805_] = i_821_;
                            } else if (i_807_ == 0) {
                                int i_822_ = this.H[i_804_];
                                if (i_822_ != 0) {
                                    if ((qp.w & 0xffffff) == 16777215) {
                                        int i_823_ = qp.w >>> 24;
            ...
            for (int i_863_ = qp.F; i_863_ < 0; i_863_++) {
                ...
                int i_869_;
                if ((i_869_
                        = (i_865_ + 1 - (this.k << 12) - qp.h) / qp.h)
                        > i_867_)
                    i_867_ = i_869_;
                if ((i_869_ = i_866_ - (this.o << 12)) >= 0) {
                ...
                for (/**/; i_867_ < 0; i_867_++) {
                    ...
                    if (i_874_ == 0) {
                        if (i_873_ == 1)
                            is_872_[i_871_] = this.H[i_870_];
                        else if (i_873_ == 0) {
                            int i_875_ = this.H[i_870_++];
                            int i_876_
                        ...
                        if (i_873_ == 1) {
                            int i_887_ = this.H[i_870_];
                            if (i_887_ != 0)
                                is_872_[i_871_] = i_887_;
                        } else if (i_873_ == 0) {
                            int i_888_ = this.H[i_870_];
                            if (i_888_ != 0) {
                                if ((qp.w & 0xffffff) == 16777215) {
                                    int i_889_ = qp.w >>> 24;
            ...
            for (int i_929_ = qp.F; i_929_ < 0; i_929_++) {
                ...
                if ((i_935_
                        = (i_932_ + 1 - (this.o << 12) - qp.n) / qp.n)
                        > i_933_)
                    i_933_ = i_935_;
                for (/**/; i_933_ < 0; i_933_++) {
                    int i_936_
                            = (i_932_ >> 12) * this.k + (i_931_ >> 12);
                    int i_937_ = i_930_++;
                    int[] is_938_ = is;
                    int i_939_ = i;
                    int i_940_ = i_406_;
                    if (i_940_ == 0) {
                        if (i_939_ == 1)
                            is_938_[i_937_] = this.H[i_936_];
                        else if (i_939_ == 0) {
                            int i_941_ = this.H[i_936_++];
                            int i_942_
                        ...
                        if (i_939_ == 1) {
                            int i_953_ = this.H[i_936_];
                            if (i_953_ != 0)
                                is_938_[i_937_] = i_953_;
                        } else if (i_939_ == 0) {
                            int i_954_ = this.H[i_936_];
                            if (i_954_ != 0) {
                                if ((qp.w & 0xffffff) == 16777215) {
                                    int i_955_ = qp.w >>> 24;
    ...
    final void a(int i, int i_995_, int i_996_, int i_997_, int i_998_,
        ...
        if (i_997_ > 0 && i_998_ > 0) {
            ...
            int i_1003_ = 0;
            int i_1004_ = 0;
            int i_1005_ = this.E + this.k + this.q;
            int i_1006_ = this.f + this.o + this.C;
            int i_1007_ = (i_1005_ << 16) / i_997_;
            int i_1008_ = (i_1006_ << 16) / i_998_;
            if (this.E > 0) {
                int i_1009_ = ((this.E << 16) + i_1007_ - 1) / i_1007_;
                i += i_1009_;
                i_1003_ += i_1009_ * i_1007_ - (this.E << 16);
            }
            if (this.f > 0) {
                int i_1010_ = ((this.f << 16) + i_1008_ - 1) / i_1008_;
                i_995_ += i_1010_;
                i_1004_ += i_1010_ * i_1008_ - (this.f << 16);
            }
            if (this.k < i_1005_)
                i_997_ = (((this.k << 16) - i_1003_ + i_1007_ - 1)
                        / i_1007_);
            if (this.o < i_1006_)
                i_998_ = (((this.o << 16) - i_1004_ + i_1008_ - 1)
                        / i_1008_);
            int i_1011_ = i + i_995_ * this.b.C;
            int i_1012_ = this.b.C - i_997_;
            if (i_995_ + i_998_ > ((qp) this).b.cb)
                i_998_ -= i_995_ + i_998_ - ((qp) this).b.cb;
            if (i_995_ < this.b.u) {
                int i_1013_ = this.b.u - i_995_;
                i_998_ -= i_1013_;
                i_1011_ += i_1013_ * this.b.C;
                i_1004_ += i_1008_ * i_1013_;
            }
            if (i + i_997_ > this.b.B) {
                int i_1014_ = i + i_997_ - this.b.B;
                i_997_ -= i_1014_;
                i_1012_ += i_1014_;
            }
            if (i < this.b.Y) {
                int i_1015_ = this.b.Y - i;
                i_997_ -= i_1015_;
                i_1011_ += i_1015_;
            ...
            int[] is = this.b.U;
            int[] is_1016_ = this.b.H;
            if (i_1001_ == 0) {
                if (i_999_ == 1) {
                    int i_1017_ = i_1003_;
                    for (int i_1018_ = -i_998_; i_1018_ < 0; i_1018_++) {
                        int i_1019_ = (i_1004_ >> 16) * this.k;
