...
public final class IDirect3DDevice extends IUnknown
{
	...
	(int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool,
	...
	(IDirect3DSurface idirect3dsurface, int i, int i_4_, int i_5_,
	 int i_6_, IDirect3DSurface idirect3dsurface_7_, int i_8_, int i_9_,
	...
	(int i, int i_13_, int i_14_, int i_15_,
	 IDirect3DSurface idirect3dsurface);
    ...
    public final native int SetPixelShaderConstantF(int i, float[] fs,
						    int i_16_);
    
    private final native int _CreateIndexBuffer
	(int i, int i_17_, int i_18_, int i_19_,
	 IDirect3DIndexBuffer idirect3dindexbuffer);
    
    public final native int SetIndices
	(IDirect3DIndexBuffer idirect3dindexbuffer);
    ...
    public final native int _CreateTexture(int i, int i_23_, int i_24_,
	...
	(int i, IDirect3DVertexBuffer idirect3dvertexbuffer, int i_28_,
	 int i_29_);
    
    public final native int _CreateVolumeTexture
	(int i, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_,
	 int i_35_, IDirect3DVolumeTexture idirect3dvolumetexture);
	...
	(int i, int i_40_, int i_41_, int i_42_, int i_43_, boolean bool,
	 IDirect3DSurface idirect3dsurface);
    
    public final native int TestCooperativeLevel();
    
    private final native int _GetSwapChain
	(int i, IDirect3DSwapChain idirect3dswapchain);
    
    public final IDirect3DVolumeTexture a(int i, int i_44_, int i_45_,
					  int i_46_, int i_47_, int i_48_,
					  int i_49_) {
	IDirect3DVolumeTexture idirect3dvolumetexture
	    = new IDirect3DVolumeTexture(c);
	int i_50_ = _CreateVolumeTexture(i, i_44_, i_45_, i_46_, i_47_, i_48_,
					 i_49_, idirect3dvolumetexture);
	if (qr.a(true, i_50_))
	    throw new bs(String.valueOf(i_50_));
	...
	IDirect3DSurface idirect3dsurface = new IDirect3DSurface(c);
	int i_51_ = _GetRenderTarget(i, idirect3dsurface);
	if (qr.a(true, i_51_))
	    throw new bs(String.valueOf(i_51_));
	return idirect3dsurface;
    }
	...
	(int i, int i_52_, int i_53_, int i_54_, int i_55_,
	 IDirect3DCubeTexture idirect3dcubetexture);
    
    public final IDirect3DTexture a(int i, int i_56_, int i_57_, int i_58_,
				    int i_59_, int i_60_) {
	IDirect3DTexture idirect3dtexture = new IDirect3DTexture(c);
	int i_61_ = _CreateTexture(i, i_56_, i_57_, i_58_, i_59_, i_60_,
				   idirect3dtexture);
	if (qr.a(true, i_61_))
	    throw new bs(String.valueOf(i_61_));
	...
	int i_65_ = _GetSwapChain(i, idirect3dswapchain);
	if (qr.a(true, i_65_))
	    throw new bs(String.valueOf(i_65_));
    ...
    public final native int SetViewport(int i, int i_67_, int i_68_, int i_69_,
					float f, float f_70_);
    
    public final IDirect3DVertexBuffer a
	...
	int i_74_ = _CreateVertexBuffer(i, i_71_, i_72_, i_73_,
					idirect3dvertexbuffer);
	if (qr.a(true, i_74_))
	    throw new bs(String.valueOf(i_74_));
	idirect3dvertexbuffer.b = i;
	return idirect3dvertexbuffer;
    }
    
    private final native int _CreateVertexBuffer
	(int i, int i_75_, int i_76_, int i_77_,
	 IDirect3DVertexBuffer idirect3dvertexbuffer);
    
    public final native int DrawIndexedPrimitive
	(int i, int i_78_, int i_79_, int i_80_, int i_81_, int i_82_);
    
    IDirect3DDevice(am var_am) {
	super(var_am);
	c = var_am;
    }
    ...
    public final IDirect3DIndexBuffer a
	(int i, int i_86_, int i_87_, int i_88_,
	 IDirect3DIndexBuffer idirect3dindexbuffer) {
	...
	int i_89_
	    = _CreateIndexBuffer(i, i_86_, i_87_, i_88_, idirect3dindexbuffer);
	if (qr.a(true, i_89_))
	    throw new bs(String.valueOf(i_89_));
	...
	(byte[] is, IDirect3DVertexShader idirect3dvertexshader);
    
    public final IDirect3DCubeTexture a(int i, int i_92_, int i_93_, int i_94_,
					int i_95_) {
	IDirect3DCubeTexture idirect3dcubetexture
	    = new IDirect3DCubeTexture(c);
	int i_96_ = _CreateCubeTexture(i, i_92_, i_93_, i_94_, i_95_,
				       idirect3dcubetexture);
	if (qr.a(true, i_96_))
	    throw new bs(String.valueOf(i_96_));
	return idirect3dcubetexture;
    }
    
    public final native int SetTexture
	(int i, IDirect3DBaseTexture idirect3dbasetexture);
    
    private final native int _GetRenderTarget
	(int i, IDirect3DSurface idirect3dsurface);
    
    public final IDirect3DSurface a(int i, int i_97_, int i_98_, int i_99_,
				    int i_100_, boolean bool) {
	IDirect3DSurface idirect3dsurface = new IDirect3DSurface(c);
	int i_101_ = _CreateRenderTarget(i, i_97_, i_98_, i_99_, i_100_, bool,
					 idirect3dsurface);
	if (qr.a(true, i_101_))
	    throw new bs(String.valueOf(i_101_));
	return idirect3dsurface;
    }
    
    public final native int SetScissorRect(int i, int i_102_, int i_103_,
					   int i_104_);
    
    public final native int _CreatePixelShader
	(byte[] is, IDirect3DPixelShader idirect3dpixelshader);
    
    private final native int _GetBackBuffer(int i, int i_105_, int i_106_,
					    IDirect3DSurface idirect3dsurface);
