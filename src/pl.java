...
final class pl
{
	...
	int i_1_ = ((ds) L).k.a(World.a(string, -13319), 106);
	if (i_1_ < 0)
	    return false;
	int i_2_ = ((ds) L).l[i_1_].a(World.a(string_0_, -13319), 119);
	if (i < 7)
	    w = true;
	if (i_2_ < 0)
	    return false;
	...
	if (!b(false))
	    return -1;
	string = string.toLowerCase();
	int i_4_ = ((ds) L).k.a(World.a(string, -13319), 99);
	if (!f(-1, i_4_))
	    return -1;
	return i_4_;
    }
	...
	int i_8_ = ((ds) L).k.a(World.a(string, -13319), 122);
	if (!f(-1, i_8_))
	    return null;
	if (i < 57)
	    f = -82;
	int i_9_ = ((ds) L).l[i_8_].a(World.a(string_7_, -13319), 99);
	...
	if (i == 54) {
	    ...
	    if (b(false)) {
		string = string.toLowerCase();
		int i_12_ = ((ds) L).k.a(World.a(string, -13319), 111);
		h(-107, i_12_);
	    }
	}
    }
	...
	if (i != 2)
	    f = 33;
	string = string.toLowerCase();
	int i_15_ = ((ds) L).k.a(World.a(string_14_, -13319), 102);
	if (!f(i ^ ~0x2, i_15_))
	    return false;
	int i_16_ = ((ds) L).l[i_15_].a(World.a(string, -13319), 120);
	...
	if (i < 46)
	    v = null;
	string = string.toLowerCase();
	int i_17_ = ((ds) L).k.a(World.a(string, -13319), 108);
	return e(63, i_17_);
    }
	...
	if (bool != false)
	    v = null;
	int i = ((ds) L).k.a(World.a(string, -13319), 111);
	return a(false, i);
    }
	...
	if (bool != true)
	    f = -111;
	int i = ((ds) L).k.a(World.a(string, -13319), 105);
	if (i < 0)
	    return false;
	return true;
    }
