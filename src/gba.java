...
final class gba extends rg {
    ...
    static gl E;
    private int F = -1;
    static int samplesPerSec;
    static int[] outScreenPlayerIDs = new int[2048];
    /*synthetic*/ static Class lang_String;
    ...
    public static void dumpHeap(int i, boolean bool, File file) {
        if (fn.l == null) {
            er.a(-30983);
        }
        dumpHeap++;
        try {
            if (i == -4496) {
                Class hotSpotDiagnosticMXBean = (Class.forName("com.sun.management.HotSpotDiagnosticMXBean"));
                Method dumpHeap1 = (hotSpotDiagnosticMXBean.getDeclaredMethod("dumpHeap", (new Class[]
                        {lang_String != null ? lang_String : (lang_String = a("java.lang.String")), Boolean.TYPE})));
                dumpHeap1.invoke(fn.l, new Object[]{file.getAbsolutePath(), new Boolean(bool)});
            }
