...
final class dc {
    ...
    static final void a(int i, LoginStream loginStream) {
        ...
        a++;
        loginStream.writeInt(ada.M.a((int) 6), (int) -127);
        ...
        loginStream.writeInt(mq.a.a((int) 6), (int) -124);
        loginStream.writeInt(av.l.a((int) 6), i ^ ~0xa8d);
        ...
        loginStream.writeInt(Login.i.a(i - 2791), (int) -124);
