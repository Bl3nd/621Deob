...
public class User32
{
    ...
    public static native boolean SetCursorPos(int i, int i_6_);
    
    public static native int LoadCursor(int i, int i_7_);
    
    public static native int SendMessage(int i, int i_8_, int i_9_,
					 Object object);
