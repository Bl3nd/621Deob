...
final class bl extends Node {
    ...
    private daa C;
    int D;
    private NativeHeapBuffer nativeHeapBuffer;
    float F;
    ...
    final void b(int size, int i_5_) {
        l++;
        nativeHeapBuffer = x.a(size * i_5_, (byte) 78, true);
        w = new Stream(nativeHeapBuffer, 0, size * 4);
    }
    ...
    final void a(byte i, int i_21_) {
        ...
        w.c();
        s = x.a(false, false);
        s.a(nativeHeapBuffer, 4, 4 * i_21_, (byte) 92);
        nativeHeapBuffer = null;
        w = null;
    }
