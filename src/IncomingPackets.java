...
abstract class IncomingPackets extends Node
{
    static BigInteger k
	= (new BigInteger
	...
	return (new GameInPacket[]
		{ pg.sendWorldListGameInPacket, fj.incomingPacket1, hi.incomingPacket2, an.incomingPacket3, qd.incomingPacket4, dfa.incomingPacket5, fh.incomingPacket6, pj.incomingPacket7, wa.incomingPacket8, ow.incomingPacket9,
